...
export const PRICES = [
  ...
  { name: 'Královská', price: 3000, description: 'Pro opravdu důležité momenty. Královská krabička nabídne luxusní kosmetiku i produkty z pravé kůže. Vždyť nejde jen o originalitu, ale také o kvalitu. ' },
]
